    ...
    <div className="w-full h-full pt-[0.4cm] px-[0.35cm] pb-[0.35cm] flex flex-col items-center relative bg-white text-black font-body" style={{ fontSize: '16px' }}>
      ...
      <div className="w-full flex items-center shrink-0 mb-2">
        ...
        <div className="w-1/2 flex items-center justify-center">
          <div 
            className="flex flex-col leading-none uppercase select-none items-center scale-[0.79] origin-center text-black"
        ...
        <div className="w-1/2 flex items-center justify-center">
          {discount > 0 && (
            <div className="w-20 h-20 bg-black text-white rounded-full flex flex-col items-center justify-center border-2 border-white shadow-md">
              <span className="text-[1.8em] font-black leading-none">{discount}%</span>
              <span className="text-[0.45em] font-bold leading-none uppercase tracking-tighter">DESCONTO</span>
            </div>
          )}
        </div>
      </div>
      ...
      <div className="w-full flex flex-col items-center pt-3 text-center shrink-0">
        ...
        {defectNote && (
          <p className="text-[0.45em] font-bold text-black uppercase mt-1">
            OBS: {defectNote.slice(0, 40)}{defectNote.length > 40 ? '...' : ''}
          </p>
        )}
      </div>
